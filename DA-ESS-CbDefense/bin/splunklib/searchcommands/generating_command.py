...
class GeneratingCommand(SearchCommand):
    ...
    |          |                                                   |                                                   |
    |          |    default/commands-scpv2.conf.                         |    .. code-block:: python                         |
    ...
    |          |         ...                                       |                                                   |
    |          |                                                   |                                                   |
    |          | Or add these lines to default/commands-scpv2.conf:      |                                                   |
    |          |                                                   |                                                   |
    |          | .. code-block::                                   |                                                   |
    |          |     retains events = true                         |                                                   |
    |          |     streaming = false                             |                                                   |
    ...
    You might also consider adding these lines to commands-scpv2.conf instead of adding them to your command class:
    ...
    |          |         ...                                       |         ...                                       |
    |          |                                                   |                                                   |
    |          | Or add this lines to default/commands-scpv2.conf:       |                                                   |
    |          |                                                   |                                                   |
    |          | .. code-block::                                   |                                                   |
    |          |     retains events = false                        |                                                   |
    |          |     streaming = false                             |                                                   |
